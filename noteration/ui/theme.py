...
Theme engine for Phase 5:
  ...
  - apply_theme(app, mode): apply QPalette + stylesheet
  - get_effective_mode(): detect OS theme (Windows/macOS/Linux)
  - watch_system_theme(callback): notification if OS theme changes
"""
